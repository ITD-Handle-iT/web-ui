    ...
    with gr.Group():
        with gr.Row():
            llm_provider = gr.Dropdown(
                ...
                label="LLM Provider",
                value=os.getenv("DEFAULT_LLM", "openrouter"),
                info="Select LLM provider for LLM",
                interactive=True
            )
            llm_model_name = gr.Dropdown(
                label="LLM Model Name",
                choices=config.model_names[os.getenv("DEFAULT_LLM", "openrouter")],
                value=config.model_names[os.getenv("DEFAULT_LLM", "openrouter")][0],
                interactive=True,
